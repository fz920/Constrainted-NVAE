...
cd $CODE_DIR
CUDA_VISIBLE_DEVICES=0 python3 train.py --data $DATA_DIR/cifar10 --root $CHECKPOINT_DIR --save $EXPR_ID --dataset cifar10 \
        --num_channels_enc 32 --num_channels_dec 32 --epochs 2 --num_postprocess_cells 2 --num_preprocess_cells 2 \
