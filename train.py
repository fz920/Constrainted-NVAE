...
def main(args):
    ...
    for epoch in range(init_epoch, args.epochs):
        ...
        if epoch == args.epochs-1:
            ...
            plt.ylabel('loss')
            plt.legend()
            plt.savefig('/data/users/fz920/Constrainted-NVAE/checkpoint/eval-24/reconstuction_loss.pdf', bbox_inches='tight')
            ...
            plt.ylabel('loss')
            plt.legend()
            plt.savefig('/data/users/fz920/Constrainted-NVAE/checkpoint/eval-24/kl_loss.pdf', bbox_inches='tight')
